...
private final ObservableList<ordersTm> obList = FXCollections.observableArrayList();
    ...
    OrdersBO bo = (OrdersBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.ORDERS);
    ...
    private void loadSupplierIds() {
        ...
        try {
            ...
            List<supplierDto> supList = bo.loadAllSuppliers();
    ...
    private void generateNextOrderId() {
        try {
            String orderId = bo.generateNextOrderId();
...
private AnchorPane root;
    ...
    public void onActionSendOrderRequestBtn(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        boolean isSaved = bo.SaveOrder(savedDto);
        if(isSaved) {

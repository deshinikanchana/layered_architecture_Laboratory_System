...
public class CollectingCentersManageFormController {
    ...
    CollectingCenterBO bo = (CollectingCenterBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.COLLECTINGCENTER);
    ...
    private void generateNextCenterId() {
        try {
            ...
            String centerId = bo.generateNextCenterId();
    ...
    private void loadAllCenters() {
        ...
        try {
            List<collectingCenterDto> dtoList = bo.loadAllCenters();

            for(collectingCenterDto dto : dtoList) {
                int count = bo.getSampleCount(dto.getCcId());
                obList.add(
    ...
    public void onActionSaveBtn(ActionEvent event) {
        ...
        try {
            boolean isSaved =bo.SaveCenter(dto);
            if (isSaved) {
    ...
    public void onActionUpdateBtn(ActionEvent event) {
        ...
        try {
            boolean isUpdated =bo.UpdateCenter(dto);
    ...
    public void onActionDeleteBtn(ActionEvent event) {
        ...
        try {
            boolean isDeleted = bo.DeleteCenter(ccId);
    ...
    public void onActionSearchTxtCenterId(ActionEvent event) {
        ...
        try {
            collectingCenterDto dto = bo.SearchCenter(null,id);

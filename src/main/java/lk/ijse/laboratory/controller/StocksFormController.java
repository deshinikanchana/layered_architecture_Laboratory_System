...
public class StocksFormController {
    ...
    StocksBO bo = (StocksBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.STOCK);
    ...
    private void generateNextItemCode() {
        try {
            String itemCode = bo.generateNextItemId();
    ...
    private void loadAllItems() {
        try {
            List<stockItemDto> dtoList = bo.loadAllItems();
    ...
    public void onActionUpdateBtn(ActionEvent event) {
        ...
        try {
            boolean isUpdated = bo.UpdateItem(dto);
    ...
    public void onActionDeleteBtn(ActionEvent event) {
        ...
        try {
            boolean isDeleted = bo.DeleteItem(id);
...
clearFields();
    ...
    public void onActionSearchTxtItemCode(ActionEvent event) {
        ...
        try {
            stockItemDto dto = bo.SearchItem("itemCode",id);

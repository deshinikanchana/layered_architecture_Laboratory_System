...
public class NewAccountBOimpl implements NewAccountBO {
    ...
    @Override
    public userDto getLastAdmin() throws SQLException, ClassNotFoundException {
        user ent = dao.getLastAdmin();
        userDto dto = new userDto(ent.getUserId(),ent.getUserName(),ent.getUserType(),ent.getPassword(),ent.getEmail());
        return dto;
    }
}
